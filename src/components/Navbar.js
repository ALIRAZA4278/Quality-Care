...
export default function Navbar() {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-50 w-full">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-start gap-4 sm:gap-8 text-xs sm:text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">+1 (678) 910-8466</span>
            </button>
            ...
            >
              <a href="tel:+16789108466" className="whitespace-nowrap">
                +1 (678) 910-8466
              </a>
            </div>
          </div>
      ...
      {/* Main Navigation */}
      <nav className="bg-gradient-to-b from-gray-100 to-white py-3 sm:py-4 md:py-5 px-4 sm:px-6 relative shadow-lg">
            ...
            <Link href="/" className="block">
              <div className="bg-white rounded-full p-2 sm:p-2.5 md:p-3 border-2 border-white ">
                <Image
                  ...
                  width={110}
                  height={110}
                  className="object-contain w-[55px] h-[55px] sm:w-[65px] sm:h-[65px] md:w-[80px] md:h-[80px] lg:w-[100px] lg:h-[100px]"
                  priority
                  quality={100}
                />
              </div>
      ...
      >
        ...
        >
          ...
          <div className="px-6 py-6 border-t border-gray-200">
            ...
            <a href="tel:+16789108466" className="text-xl font-bold text-gray-900 hover:text-[#887904] transition-colors">
              +1 (678) 910-8466
            </a>
          </div>
          ...
          <div className="px-6 py-6 border-t border-gray-200">
            <div className="flex gap-3 justify-center">
              <a href="https://www.facebook.com/profile.php?id=61585888921260" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-[#887904] rounded-full flex items-center justify-center hover:bg-[#6d5f03] transition-colors" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/qualitycareseniorliving/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-[#887904] rounded-full flex items-center justify-center hover:bg-[#6d5f03] transition-colors" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white">
