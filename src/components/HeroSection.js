...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-[85vh] sm:h-[90vh] md:h-screen mt-0">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 h-full flex flex-col items-center justify-center text-center pt-24 sm:pt-28 md:pt-32 lg:pt-0">
        {/* Main Heading */}
        <h1
