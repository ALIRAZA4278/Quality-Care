      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="relative w-full aspect-[3/2.5] max-w-[500px] sm:max-w-[600px] mx-auto lg:mx-0">
            ...
            <div className="absolute top-8 sm:top-35 -left-6 sm:-left-10 w-[30%] h-[65%] bg-black rounded-[20px] sm:rounded-[32px]"></div>

            {/* Main Large Image - Taller and bigger */}
            <div className="absolute top-[-5%] sm:top-[-8%] left-[0] w-[85%] h-[95%] rounded-[20px] sm:rounded-[32px] overflow-hidden shadow-2xl">
              <Image
                src="/home/about1.png"
             ...
             {/* Logo Badge */}
              <div className="absolute top-1 sm:top-2 right-6 sm:right-10 bg-white rounded-full p-2 sm:p-4 shadow-lg">
                <Image
                  ...
                  width={60}
                  height={60}
                  className="object-contain sm:w-[85px] sm:h-[85px]"
                />
              </div>

            {/* Years of Experience Text - Bottom Left, overlapping */}
            <div className="absolute -bottom-[10%] sm:-bottom-[2%] left-[10%] sm:left-[25%] z-10">
              <div
            ...
            <div className="absolute -bottom-6 sm:-bottom-8 -right-3 sm:-right-5 w-[50%] h-[65%] bg-white rounded-[20px] sm:rounded-[32px] border-8 sm:border-10 border-white p-2 sm:p-4 shadow-2xl">
              <div className="w-full h-full rounded-[16px] sm:rounded-[20px] overflow-hidden">
                <Image
                  src="/home/about2.png"
                  alt="Seniors in living room"
                  fill
                  className="object-cover rounded-[16px] sm:rounded-[32px]"
                />
              </div>
            </div>
          </div>
          ...
          <div className="lg:pl-8 mt-8 lg:mt-0">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start gap-2 sm:gap-3">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-[#887904] mt-1 flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">24/7 Trained Staff</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-[#887904] mt-1 flex-shrink-0"
            ...
            <Link
              href="/about"
              className="bg-black text-white pl-6 sm:pl-8 pr-2 py-2.5 sm:py-3 rounded-full font-medium hover:bg-[#1f3329] inline-flex items-center gap-3 sm:gap-4 transition-colors text-sm sm:text-[15px]"
            >
              LEARN MORE
